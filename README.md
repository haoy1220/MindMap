...
[ubuntu忘记mysql的root密码--解决方案](./mysql/ubuntu忘记mysql的root密码--解决方案.md)

[windows下重置mysql密码](./mysql/windows下重置mysql密码.md)
...
[八大基础排序](./sortAlgorithm/八大基础排序.md)



#### 软件测试

[软件测试工程师发展方向知识架构体系图](./软件测试/软件测试工程师发展方向知识架构体系图.md)
